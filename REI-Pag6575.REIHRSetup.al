page 70976575 "REI-HRSetup"
{
    
    ApplicationArea = All;
    Caption = 'REI-HRSetup';
    PageType = List;
    SourceTable = "REI-HR Setup";
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the AllOfUs-Mail field.';
                    ApplicationArea = All;
                }
                ...
                field("CIS Team E-mail"; Rec."CIS Team E-mail")
                {
                    ToolTip = 'Specifies the value of the CIS Team E-mail field.';
                    ApplicationArea = All;
                }
                ...
                field("DE Team E-mail"; Rec."DE Team E-mail")
                {
                    ToolTip = 'Specifies the value of the DE Team E-mail field.';
                    ApplicationArea = All;
                }
                field("DS Team E-mail"; Rec."DS Team E-mail")
                {
                    ToolTip = 'Specifies the value of the DS Team E-mail field.';
                    ApplicationArea = All;
                }
                ...
                field("ID Card Request No."; Rec."ID Card Request No.")
                {
                    ToolTip = 'Specifies the value of the ID Card Request No. field.';
                    ApplicationArea = All;
                }
                ...
                field("SO Team E-mail"; Rec."SO Team E-mail")
                {
                    ToolTip = 'Specifies the value of the SO Team E-mail field.';
                    ApplicationArea = All;
                }
                ...
                field("View Employee Records"; Rec."View Employee Records")
                {
                    ToolTip = 'Specifies the value of the View Employee Records field.';
                    ApplicationArea = All;
                }
            }
        }
