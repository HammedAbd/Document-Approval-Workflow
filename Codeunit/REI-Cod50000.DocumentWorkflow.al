codeunit 50000 "REI-Document Approval Workflow"
{
    ...
    var
        ...
        Text018: Label '%1 requires your urgent payment processing. Kindly proceed to disburse the payment to the beneficiary on the approved payment requisition page.';
    ...
    begin
        IF TableID IN [50001, 50011, 50013,50014,50016,50018] THEN
